...
public class RegistrationPage extends BrowserSetup {
	WebDriver driver;
	...
	public void SetFbRegistrationPageFirstname(String name) {
		firstname.sendKeys(name);
		Reporter.log("SetFbRegistrationPageFirstname",true);
	}
	
	public void SetFbRegistrationPageLastname(String lname) {
		lastname.sendKeys(lname);
		Reporter.log("SetFbRegistrationPageLastname",true);
	}
	
	public void SetFbRegistrationPageMobileEmail(String mail) {
		mobile_emailid.sendKeys(mail);
		Reporter.log("SetFbRegistrationPageMobileEmail",true);
	}
	
	public void SetFbRegistrationPagePassword(String pass) {
